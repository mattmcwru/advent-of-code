...
pub fn main() !void {
    ...
    var expansion_rate: usize = 1000000;
    ...
    while (try in_stream.readUntilDelimiterOrEof(&buf, '\n')) |line| {
        ...
        line_y += if (!galaxy_found) expansion_rate else 1;
    ...
    // Insert extra columns
    {
        ...
        while (i > 0) {
            ...
            add_rows = if (!galaxy_found) expansion_rate - 1 else 0;
            if (!galaxy_found) print("No galaxy col {}\n", .{i});
        }
    }
